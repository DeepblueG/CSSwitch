...
- [CSSwitch 产品与 Claude Science 能力地图](product-science-capability-map.md)：维护唯一的逐能力决策表，包括 Science 官方 owner、第三方模式处理、non-target、当前证据层与 `UNKNOWN`。
- [外部 Skill bridge](external-skill-bridge.md)
